...
<body class="overflow-x-hidden">
    ...
    <main class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="flex items-center justify-between my-10">
            <h1 class="text-3xl moraba"><img src="https://github.com/Tarikul-Islam-Anik/tarikul-islam-anik/raw/main/assets/images/Hourglass%20Done.png" class="h-8 w-8 inline" alt=""> ايجاد يادداشت</h1>
